export const lang = {
    ...
    form: {
        ...
        checkbox: {
            text: 'Self-destruct',
            popover: 'Disable unless login, but there is no login yet',
        },
        count: {
            prepend: 'access',
            append: 'times',
    ...
    not_found: {
        ...
        footer: {
            text: 'If you\'d like to know more, you can search online later for this error: ERROR_404_GIRLFRIEND_NOT_FOUND',
            beg: {
                left: 'Please give me one',
                right: 'in GitHub',
            }
        }
    },
    footer: {
        tooltip: {
            refresh: 'Click to change',
            wait: 'Wait {sec} seconds to refresh',
        },
    },
    view: {
        parsed: 'Parsed',
